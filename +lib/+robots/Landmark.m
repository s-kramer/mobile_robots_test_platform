...
classdef Landmark < lib.robots.Robot
    ...
    methods
        ...
        %arg3 - range of view
        %arg4 - forcelaw obiect
        function obj = Landmark(parent,state,varargin)
            ...
            elseif(numel(varargin)==2)
                obj.viewRange = 25;
                obj.forceLaw = varargin{1};
                obj.groups{end+1} = strcat('landmark',int2str(varargin{2}));
